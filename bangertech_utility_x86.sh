...
CHOICES=$(whiptail --backtitle "The BangerTECH Utility X86 VERSION" --title "SELECT PACKAGES TO INSTALL"  --checklist "Choose options" 29 85 22 \
  ...
  if whiptail --backtitle "The BangerTECH Utility X86 VERSION" --title "CONFIRMATION" --yesno "You are about to install: $CHOICES" 8 82; then 
    ...
    case "$CHOICE" in
      ...
      '"Backup"')
        ...
        whiptail --backtitle "The BangerTECH Utility X86 VERSION" --title "MESSAGE" --msgbox "You´re save. Cloning complete." 8 82
        else 
          whiptail --backtitle "The BangerTECH Utility X86 VERSION" --title "MESSAGE" --msgbox "Please redo the installation" 8 82
        fi
      ;;
